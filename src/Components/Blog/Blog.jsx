            ...
            <div className="blog-lists">
                {
                    blogTexts.map(blog => (
                        <div className="single-blog">
                            <BlogComponent slug = {blog.slug}  isSave = {props.save_data?.includes(blog.id)} isLike = {props.like_data?.includes(blog.id)} id = {blog.id} popular={blog.isPopuler} last={blog.isLast} date={blog.date} image={blog.image} header={blog.header} summary={blog.summary} />
                        </div>
                    ))
                }
            </div>
