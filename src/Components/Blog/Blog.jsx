...
export default function Blog() {
    ...
    return (
        <div className="blog">
            <div className="loader" style={{ display: loading === true ? "flex" : "none" }}>
                <img src={Loader} />
            </div>
            <div className="top" style={{ display: loading === false ? "flex" : "none" }}>
            ...
            <hr></hr>
            <div className="blog-lists" style={{ display: loading === false ? "flex" : "none" }}>
                {
                    blogTexts.map(blog => (
